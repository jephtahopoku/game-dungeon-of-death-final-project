...
public class App {
    ...
    public static void main(String[] args) throws UnsupportedAudioFileException, IOException, Exception {
        System.out.println(
                "You are a warrior long dead, and forsaken you're memories are no longer with you. You have been risen once more, to earn back your life and memories, but first [look] around ");
       ...
       /*  File file = new File("aura (1).wav");
        AudioInputStream audioO = AudioSystem.getAudioInputStream(file);
        Clip clip = AudioSystem.getClip();
        clip.open(audioO);
        clip.start();*/
        //System.out.println("Enter endMusic to stop music before you start the game if you wish to.");
        // The main game loop.
        while (gameRunning) {
            ...
            } //else if (input[0].toLowerCase().equals("endmusic")){
               // clip.stop();
    ...
    public static String[] getCommand() {
        ...
        System.out.println("\n------------------------------");
        System.out.print("Warrior what would you like to do? >  ");
    ...
    public static void unknownCommand(String input) {
        if (Math.random() < .3) // A random chance for a silly response.
            System.out.println("Silly warrior '" + input + "' is not a command! Type ? for help.");
        else
            System.out.println("Warrior I don't understand '" + input + "'. Type ? for help.");
    }
